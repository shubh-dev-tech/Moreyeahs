  ...
  <div class="news-block__container">
    <div class="news-block__grid">
      ...
      <article 
        ...
        style="--bg-image: <?php echo $bg_image ? 'url(' . esc_url($bg_image) . ')' : 'none'; ?>; --bg-color: <?php echo esc_attr($bg_color); ?>;"
      >
      ...
      ?>
        <article 
          class="news-block__item"
          style="--bg-image: <?php echo $item_bg ? 'url(' . esc_url($item_bg) . ')' : 'none'; ?>; --bg-color: <?php echo esc_attr($item_bg_color); ?>;"
        >
          <div class="news-block__overlay"></div>
          <div class="news-block__content">
            <div>
