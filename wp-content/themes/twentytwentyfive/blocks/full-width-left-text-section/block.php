...
$css_vars = sprintf(
    '--bg-color: %s; --section-height: %s; --section-width: %s; --padding-top: %s; --padding-right: %s; --padding-bottom: %s; --padding-left: %s; --margin-top: %s; --margin-bottom: %s;',
...
<section id="<?php echo esc_attr($block_id); ?>" class="<?php echo esc_attr($class_name); ?>" style="<?php echo $css_vars; ?>">
