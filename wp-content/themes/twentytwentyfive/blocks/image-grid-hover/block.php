...
$block_path_uri = get_template_directory_uri() . '/blocks/image-grid-hover';
$block_path_dir = get_template_directory() . '/blocks/image-grid-hover';

// Enqueue styles
if (file_exists($block_path_dir . '/style.css')) {
    wp_enqueue_style(
        'image-grid-hover-style', 
        $block_path_uri . '/style.css', 
        array(), 
        filemtime($block_path_dir . '/style.css')
    );
}

// Enqueue scripts
if (file_exists($block_path_dir . '/script.js')) {
    wp_enqueue_script(
        'image-grid-hover-script', 
        $block_path_uri . '/script.js', 
        array(), 
        filemtime($block_path_dir . '/script.js'), 
        true
    );
}
